...
Στην αρχική σελίδα (καρτέλλα Live), ο χρήστης μπορεί να δει τα περισσότερα στοιχεία στην Ελληνική γλώσσα. Για την ανάγνωση των υπόλοιπων καρτέλλων είναι απαραίτητη η γνώση της αγγλικής γλώσσας.
