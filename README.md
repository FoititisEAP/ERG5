...
Η απεικόνιση είναι άμεσα διαθέσιμη, ενώ ο χρήστης έχει την αίσθηση ότι από την αρχική οθόνη έχει τη δυνατότητα να επιλέξει τις κυριότερες λειτουργίες. Για τη χρήση της, είναι απαραίτητη η γνώση της αγγλικής γλώσσας.
...
Πιο κάτω, φαίνονται οι επιλογές εμφάνισης στρώματος ανέμου και ηλιοφάνειας επάνω στον Άτλα, ενώ υπάρχει και η δυνατότητα εναλλαγής σκοτεινής εμφάνισης, το οποίο είναι αρκετά χρήσιμο από μεριάς χρήστη - για παράδειγμα - σε περιβάλλον έντονου φωτισμού. Ένα πολύ σημαντικό σημείο της εφαρμογής είναι ότι (όπως αναφέρεται στην αρχική σελίδα) είναι το στοιχείο "φιλικό προς αχρωματοψία", και το οποίο υπάρχει στον κάτω-αριστερά χώρο της σελίδας. Πατώντας το, ο χάρτης αλλάζει χρωματισμό για την εξυπηρέτηση αυτού του σκοπού.
...
**β) Μοντέλα χωρο-χρονικών οντοτήτων.**


α) Στιγμιότυπα (Snapshot). Χρησιμοποιώντας αυτό το απλούστερο μοντέλο, δημιουργούνται πολλαπλά διαδοχικά στιγμιότυπα ανά χρονική στιγμή. Είναι εύκολο και απλό στη χρήση, αλλά δεν καταγράφει τις μεταβολές μεταξύ των στιγμιοτύπων, τις οποίες θα πρέπει να βρει ο χρήστης, ενώ ακόμη και σε περίπτωση που δε συμβαίνει κάποια αλλαγή, δημιουργούνται στιγμιότυπα ούτως ή άλλως.


β) Αποτύπωση χρόνου (Time-Stamping). Κάθε οντότητα έχει δύο αποτυπώματα χρονικών στιγμών: της δημιουργίας της και της παύσης της. Έτσι, κατά τη διάρκεια της "ζωής" τους, μόνο ο "ενεργός" (valid) τους χρόνος αποθηκεύεται ως χαρακτηριστικό τους, με συνέπεια να δημιουργούνται "εκδόσεις" τους. Αυτό όμως έχει σαν συνέπεια το να φαίνεται η μεταβολή που έχει γίνει και όχι ο λόγος για τον οποίο συνέβει.


γ) Ιστορικό γράφημα (History Graph). Εδώ, από τη μία πλευρά δημιουργούνται 3 είδη συμπεριφοράς αντικειμένων σε σχέση με τον χρόνο: συνεχώς μεταβαλλόμενα, στατικά που µεταβάλλονται σε συνεχείς περιόδους και στατικά που µεταβάλλονται µε αιφνίδια συµβάντα, και από την άλλη εντοπίζονται οι χρονικές συμπεριφορές τους. Μία οντότητα μπορεί να είναι είτε στατική είτε μεταβαλλόμενη είτε έχει παύσει να υφίσταται. Σε αυτό το μοντέλο συνδυάζεται το μοντέλο καταγραφής συμβάντων/στιγμιοτύπων με αυτό της αποτύπωσης χρόνου, με θετικό αντίκτυπο την ικανότητα διατύπωσης ερωτημάτων σε σχέση με την κίνηση και τη μεταβολή.


δ) Τρεις περιγραφικές περιοχές. Αυτές είναι: ο χώρος, ο χρόνος και οι σημασιολογικές οντότητες, οι οποίες αφορούν ανθρώπινες έννοιες που δε σχετίζονται με τη γεωγραφική και χρονική τους θέση. Το μειονέκτημα αυτού του μοντέλου είναι ότι δεν περιγράφονται καλά οι συσχετίσεις μεταξύ των αντικειμένων.


ε) Κινούμενα αντικείμενα (m-objects). Η θέση του αντικειμένου στο χώρο είναι σχετική. Αν το αντικείμενο απεικονίζεται ως σημείο, τότε η βασική αφαιρετική απεικόνιση είναι το "κινούµενο σηµείο" (mpoint). Εάν απεικονίζεται ως μέρος επιφάνειας και άρα μας ενδιαφέρει η έκτασή του, τότε η "κινούµενη επιφάνεια" (mregion) συλλαµβάνει την κίνησή του, που αφορά τη µεγέθυνση ή τη συρρίκνωσή του. Εάν προσθέσουμε τον χρόνο t ως επιπλέον χαρακτηριστικό των οντοτήτων, τότε υπάρχει η δυνατότητα της παρακολούθησης της κίνησής τους. Αναπαριστώντας τα ως συναρτήσεις, το κινούµενο σηµείο είναι η συνάρτηση f : time → σηµείο, η κινούµενη γραµµή f : time → γραµµή και η κιν. επιφάνεια f : time → πολύγωνο. Τα κινούµενα σηµεία, γραµµές και επιφάνειες θεωρούνται τρισδιάστατες οντότητες. Στην Εικόνα 1.2.4, οι τροχιές αντιστοιχίζονται είτε σε m-points είτε σε m-regions.


![Εικόνα 1.2.4](./Εικόνες/1-2-4.jpg)


Εικόνα 1.2.4

Η εξέλιξη της τεχνολογίας και η βελτίωση των τεχνικών οπτικοποίησης έχουν σαν συνέπεια αυτο µοντέλο να χρησιµοποιείται ευρύτατα σε εφαρµογές στις οποίες υπάρχει συνεχής κίνηση αντικειμένων (ενηµέρωσης της θέσης τους µε δέκτες GPS) π.χ. εφαρµογές πλοήγησης, διαχείρισης στόλου, µετεωρολογικών προγνώσεων κ.α.


**γ) Οπτικοποίηση του χρόνου.**


 Γενικά ο χρόνος οπτικοποιείται µε τη χρήση χρονικού σηµείου ή χρονικού διαστήματος. Προτιμάται η δεύτερη γιατί είναι εύκολο να ανευρεθεί εάν κάποια γεγονότα άρχισαν/ ολοκληρώθηκαν ταυτόχρονα ή εάν γεγονότα επικαλύπτονται. Γεγονότα συγκρίνονται σε διαφορετικά σηµεία στο χρόνο και παρατηρούνται αλλαγές. Η οπτικοποίηση επηρεάζεται από τη φύση των δεδοµένων (χωρικά ή ασαφή), τον τρόπο περιγραφής του χρόνου (γραµµικός, κυκλικός, µε διακλαδώσεις), τον τρόπο αναπαράστασης και την αναγκαιότητα ή µη της διαδραστικότητας.  Στην Εικόνα 1.2.5 απεικονίζονται μέθοδοι οπτικοποίησης για ανάλυση χρονικών δεδοµένων, ενώ στη Εικόνα 1.2.6 τρεις εφαρμογές οπτικοποίησης του χρόνου.


![Εικόνα 1.2.5](./Εικόνες/1-2-5.jpg)


Εικόνα 1.2.5


![Εικόνα 1.2.6](./Εικόνες/1-2-6.jpg)
...
**δ) Οπτικοποίηση του χώρου.**


Ο κύριος τρόπος οπτικοποίησης του χώρου - διαχρονικά - είναι ο χάρτης. Γνωστά παραδείγματα είναι τα: Google Maps, Google Earth, Open Street Maps και Bing Maps. Σε αυτά γίνεται χρήση είτε μόνο διανυσματικών χαρτών είτε και συνδυασμός με δορυφορικές εικόνες ή ακόμη και τρισδιάστατη απεικόνιση με κίνηση.


**ε) Οπτικοποίηση χωρο-χρονικών δεδομένων.**


Για την οπτικοποίηση χωρο-χρονικών δεδομένων είναι απαραίτητη η χρήση τεχνικών διερεύνησης και παρουσίασης, για την υποβοήθηση της ικανότητας των ανθρώπων στην χαρτογράφηση της πληροφορίας με χωροχρονικές αλλαγές. Η οπτικοποίηση μπορεί να κατηγοριοποιηθεί σε επιστημονική (απεικόνιση επιστημονικών δεδομένων με χωρο-χρονικές αναφορές) και οπτικοποίηση πληροφορίας (αφηρημένα δεδομένα χωρίς χωροχρονικές πληροφορίες). Η γεω-οπτικοποίηση χρησιμοποιεί στοιχεία επιστημονικής οπτικοποίησης, οπτικοποίησης πληροφορίας, χαρτογραφίας, ανάλυσης εικόνων, διερευνητικής ανάλυσης δεδοµένων και GIS, για την οπτική επεξεργασία και παρουσίαση χωροχρονικών δεδοµένων. Παράδειγμα αποτελούν οι χρονικοί χάρτες.


Τεχνικές οπτικοποίησης χωροχρονικών δεδομένων:


α) Απλοί στατικοί χάρτες.


β) Πολλαπλές απεικονίσεις (Multiple views).


γ) Τρισδιάστατες απεικονίσεις φαινοµένων (isosurfaces).


δ) Κινούµενες εικόνες (animation).


ε) Συνδυασµός των ανωτέρω( υβριδικές τεχνικές).
...
Το νέο Σύστημα θα πρέπει να συνδυάζει τα κύρια στοιχεία των δύο προηγούμενων εφαρμογών και να εμφανίζει στοιχεία εκπομπών στις διάφορες διοικητικές διαιρέσεις της χώρας ή της ενότητας χωρών την οποία επιλέγει ο χρήστης. Για παράδειγμα, στην Ελλάδα, θα εμφανίζει στοιχεία για τις περιφέφειες, περιφερειακές ενότητες, δήμους, κλπ. Επίσης, θα πρέπει να εμφανίζει τη χρήση ανανεώσιμων πηγών ενέργειας στις επιλεγμένες περιοχές, και την αντιστοιχία χρήσης σε ποσοστό ανά νοικοκυριό. Προϋπόθεση, βεβαίως είναι η ύπαρξη τέτοιων δεδομένων και η νόμιμη χρήση τους στο λογισμικό μας. Ακόμη, θα μπορούσε να εμφανίζει προτάσεις για τη βελτίωση της ενεργειακής απόδοσης ανά περιοχή, και την προβολή βέλτιστων λύσεων/παραδειγμάτων/πρακτικών που υφίστανται σε χρήση από διάφορες χώρες του κόσμου. Τέλος, μπορεί να συνδυάζει της πληροφορίες εκπομπής αερίων με τις κλιματολογικές συνθήκες που επικρατούν στον επιλεχθέντα τόπο. Στα προηγούμενα συστήματα δεν αναφέρεται η λύση της χρήσης της αέναης και σχεδόν ανεξάντλητης ενέργειας της θάλασσας (ή άλλων εναλλακτικών τύπων εκμετάλλευσης ενέργειας), κάτι που θα πρέπει να προστεθεί στη δική μας εφαρμογή, ακόμη και σε χώρες στις οποίες βρίσκεται σε πειραματικό στάδιο, για την ενημέρωση και προώθησή της χρήσης της από τον κόσμο.


Το σύστημα θα παρέχει τις πληροφορίες του και στην ελληνική γλώσσα (εκτός από την αγγλική), με σκοπό να προστίθενται και άλλες, ανάλογα με το βαθμό επισκεψιμότητάς του, με τη βοήθεια εθελοντών από διάφορες περιοχές του κόσμου (όπως γίνεται για παράδειγμα στην wikipedia).


Ακόμη, στον Παγκόσμιο Άτλα, θα πρέπει να υπάρχουν πληροφορίες για την Ανταρκτική (η οποία θα εμφανίζεται σε αυτόν), όπως και για τον βόρειο παγωμένο ωκεανό. Σε αυτές τις περιοχές υπάρχει ανθρώπινη δραστηριότητα, η οποία αναμένεται στο μέλλον να εκτοξευθεί.


Ακόμη, θα μπορούσαν να εμφανίζονται πληροφορίες σε σχέση με την παραγωγή ενεργοβόρων ή μη υλικών, και πρόταση για χρήση ανακυκλώσιμων/φυσικών υλικών.


**1. Περιγραφή περσόνας.** 


Η Αφροξυλάνθη είναι 24 ετών έχει καταγωγή από την Σίνδο Θεσσαλονίκης. Ο πατέρας της είναι Δημοτικός Σύμβουλος στο Δήμο Σίνδου. Είναι απόφοιτος του Τμήματος Τεχνολογία Αλιείας και Υδατοκαλλιέργειας του πρώην Α-ΤΕΙ Θεσσαλονίκης και παρακολουθεί βασικά μαθήματα Τεχνικού Αισθητικού Ποδολογίας – Καλλωπισμού νυχιών & Ονυχοπλαστικής, στο ΙΕΚ "anko" της Ρόδου. Είναι αρραβωνιασμένη και της αρέσει η οικολογία. Ενδιαφέρεται για θέματα που αφορούν τη μόλυνση του περιβάλλοντος, αλλά και αγοράζει συχνά βιολογικά προϊόντα. Κατέχει αναγνωρισμένο από το κράτος πτυχίο για την χρήση Η/Υ (ECDL), ενώ παράλληλα έχει πτυχίο αγγλικής γλώσσας επιπέδου Lower.


**2. Σενάριο χρήσης.**


Η Αφροξυλάνθη, σήμερα Σάββατο, νιώθει ότι θέλει να ξεφύγει από το διάβασμα της καθημερινότητας και θέλει να ασχοληθεί με κάτι που της αρέσει. Πριν λίγες ημέρες επέστρεψε από το ταξίδι της στη Σίνδο, και συνειδητοποίησε ότι ο αέρας εκεί είναι αρκετά μολυσμένος σε σχέση με αυτόν της Ρόδου. Μάλλον η Βιομηχανική Περιοχή Σίνδου είναι ο λόγος και η μεγάλη πόλη που είναι κοντά. Κάθετε μπροστά στο κινητό της τηλέφωνο και σκέφτεται να κάνει μία αναζήτηση σε σχέση με τις εκπομπές αερίων θερμοκηπίου στην αγγλική γλώσσα. Εμφανίζονται πολλά αποτελέσματα της μηχανής αναζήτησης στον περιηγητή ιστοσελίδων. Επιλέγει τη διαδικτυακή εφαρμογή μας. Της αρέσει το ότι το κείμενο εμφανίζεται στην Ελληνική γλώσσα, όπως επίσης το σχόλιο που αναφέρει ότι δημιουργήθηκε με εργαλεία Λογισμικού Ανοιχτού Πηγαίου Κώδικα και το ότι βλέπει τον Παγκόσμιο Άτλα και τις εκπομπές αερίων θερμοκηπίου πάνω σε αυτόν. Κάνοντας χρήση της μπάρας κύλισης του ποντικιού εστιάζει στην Ελλάδα, και πολύ περισσότερο στη Σίνδο, όπου κάνει κλικ. Βλέπει με έντονο κόκκινο χρωματισμό ότι στην περιοχή εκπέμπονται μεγάλες ποσότητες αερίων θερμοκηπίου (παρουσιάζονται: η Ένταση Άνθρακα (σε gCO₂eq/kWh), το ποσοστό είδους ενέργειας με χαμηλές εκπομπές άνθρακα, το ποσοστό Ανανεώσιμων πηγών ενέργειας), ενώ σε δεύτερο χρόνο εστιάζει στην πόλη της Ρόδου, όπου ο χρωματισμός είναι πολύ πιο ανοιχτός, με τα στοιχεία να αναφέρουν ότι δεν εκπέμπονται μεγάλες ποσότητες αερίων. Γνωρίζει ότι στη Ρόδο ο χειμώνας δεν είναι ίδιος όπως στην Μακεδονία και ότι η κατανάλωση ενέργειας για θέρμανση είναι σαφώς μεγαλύτερη στο πατρικό της σπίτι απ'ότι στο ενοικιαζόμενο διαμέρισμά της στη Ρόδο. "Θα πρέπει να λάβουμε κάποια μέτρα γι' αυτό. Μάλλον θα πρέπει να αναβαθμίζουμε ενεργειακά το πατρικό μας σπίτι", σκέφτεται. "Έτσι, το χρέος μας θα το κάνουμε ως ένα βαθμό". Βλέπει τις προτάσεις για βελτίωση της ενεργειακής απόδοσης ανά περιοχή, και την προβολή βέλτιστων λύσεων/παραδειγμάτων/πρακτικών που υφίστανται σε χρήση από διάφορες χώρες του κόσμου. Διαπιστώνει, κάνοντας κλικ στο "Πηγές" ότι τα στοιχεία της εφαρμογής πηγάζουν από ερευνητικά κέντρα και εθελοντές επιστήμονες από όλο τον κόσμο. Αυτά είναι κάποια στοιχεία που μπορεί να αναφέρει στον πατέρα της και να γίνει μία συζήτηση στο Δημοτικό Συμβούλιο γι'αυτά, και το τι μπορεί να κάνει ο Δήμος για να λάβει κάποια μέτρα προστασίας όσον αφορά τις εκπομπές αερίων θερμοκηπίου και την προστασία του περιβάλλοντος. Είναι αρκετά ευχάριστο το ότι δε χρειάστηκε ούτε μια στιγμή να κάνει είσοδο στο σύστημα ή να δώσει τα προσωπικά της στοιχεία για να χρησιμοποιήσει την εφαρμογή. Συνεχίζει πατώντας στο "ΠΟΡΕΙΑ", και βλέπει την “ιστορία” των εκπομπών αερίων θερμοκηπίου, το παρόν και το πιθανό μέλλον, κάτι που την εντυπωσιάζει θετικά. Προσθέτει τον ιστοχώρο  στα “Αγαπημένα” και κλείνει τον περιηγητή ιστοσελίδων.
...
Με τη χρήση του [figma](https://www.figma.com/), δημιουργήθηκαν οι παρακάτω ενδεικτικές οθόνες.


Στην πρώτη(Εικόνα 1.3.1), φαίνεται η αρχική σελίδα, από όπου ο χρήστης μπορεί να επιλέξει τη γλώσσα εμφάνισης κειμένου της επιλογής του, και είτε να εστιάσει μέσω του Παγκόσμιου Άτλαντα είτε να αναζητήσει την τοποθεσία/χώρα που τον ενδιαφέρει μέσω της Εύρεσης. Η αναζήτηση γίνεται αυτόματα κατά την πληκτρολόγηση. 


![Εικόνα 1.3.1](./Εικόνες/1-3-1.jpg)
...
Ακόμη, επιλέγοντας "Πηγές", ο χρήστης βλέπει την Εικόνα 1.3.2, από όπου μπορεί να δει τις ερευνητικές ομάδες, πανεπιστήμια ή αυτόνομους ερευνητές από τις οποίες προέρχονται τα δεδομένα που απεικονίζονται στην εφαρμογή. Πατώντας το πλήκτρο "Πίσω", μεταφέρεται στην αρχική σελίδα.


![Εικόνα 1.3.2](./Εικόνες/1-3-2.jpg)
...
Και τέλος, επιλέγοντας από την αρχική σελίδα "Πορεία", ο χρήστης βλέπει την Εικόνα 1.3.3, από όπου ο χρήστης μπορεί να επιλέξει να δει στοιχεία είτε από το παρελθόν ή το μέλλον των εκπεμπόμενων αερίων θερμοκηπίου είτε να δει μία πιθανή προσομοίωση του μέλλοντος, ανάλογα με τις αντίστοιχες επιλογές της ανθρωπότητας. Πατώντας το πλήκτρο "Πίσω", μεταφέρεται στην αρχική σελίδα.


![Εικόνα 1.3.3](./Εικόνες/1-3-3.jpg)
