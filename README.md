...
Ένα χρονικό GIS, θα πρέπει να απαντά στα εξής τρία ερωτήματα: α) Ερώτημα μεταβολών σε ένα Αντικείμενο (π.χ. μετακίνησή του). β) Ερώτημα μεταβολών στα Χωρικά χαρακτηριστικά του (π.χ. αλλαγή χρήσης γης). γ) Ερώτημα μεταβολών των Χρονικών Συσχετίσεων μεταξύ πολλαπλών Γεωγραφικών φαινομένων (π.χ. αλλαγή χρήσης γης εντός κάποιας απόστασης μετά από κάποιο συμβάν).
