...
Το νέο Σύστημα θα πρέπει να εμφανίζει στοιχεία εκπομπών στις διάφορες διοικητικές διαιρέσεις της χώρας ή της ενότητας χωρών την οποία επιλέγει ο χρήστης. Για παράδειγμα, στην Ελλάδα, θα εμφανίζει στοιχεία για τις περιφέφειες, περιφερειακές ενότητες, δήμους, κλπ. Επίσης, θα πρέπει να εμφανίζει τη χρήση ανανεώσιμων πηγών ενέργειας στις επιλεγμένες περιοχές, και την αντιστοιχία χρήσης σε ποσοστό ανά νοικοκυριό. Προϋπόθεση, βεβαίως είναι η ύπαρξη τέτοιων δεδομένων και η νόμιμη χρήση τους στο λογισμικό μας. Ακόμη, θα μπορούσε να εμφανίζει προτάσεις για τη βελτίωση της ενεργειακής απόδοσης ανά περιοχή, και η προβολή βέλτιστων λύσεων/παραδειγμάτων/πρακτικών που υφίστανται σε χρήση από διάφορες χώρες του κόσμου. Στα προηγούμενα συστήματα δεν αναφέρεται η λύση της χρήσης της αέναης και σχεδόν ανεξάντλητης ενέργειας της θάλασσας (ή άλλων εναλλακτικών τύπων εκμετάλλευσης ενέργειας), κάτι που θα πρέπει να προστεθεί στη δική μας εφαρμογή, ακόμη και σε χώρες στις οποίες βρίσκεται σε πειραματικό στάδιο, για την ενημέρωση και προώθησή της χρήσης της από τον κόσμο.
...
Η Αφροξυλάνθη είναι 24 ετών. Είναι απόφοιτος του Τμήματος Τεχνολογία Αλιείας και Υδατοκαλλιέργειας του πρώην Α-ΤΕΙ Θεσσαλονίκης και παρακολουθεί βασικά μαθήματα Τεχνικού Αισθητικού Ποδολογίας – Καλλωπισμού νυχιών & Ονυχοπλαστικής, στο ΙΕΚ "anko" της Ρόδου. Είναι αρραβωνιασμένη και της αρέσει η οικολογία. Ενδιαφέρεται για θέματα που αφορούν τη μόλυνση του περιβάλλοντος, αλλά και αγοράζει συχνά βιολογικά προϊόντα. Έχει έναν τυφλό αδελφό. Κατέχει αναγνωρισμένο από το κράτος πτυχίο για την χρήση Η/Υ (ECDL), ενώ παράλληλα έχει πτυχίο αγγλικής γλώσσας επιπέδου Lower.
