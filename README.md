...
"Ο χρόνος εννοείται "η ακαθόριστη κίνηση της ύπαρξης και των γεγονότων στο παρελθόν, το παρόν και το µέλλον, θεωρούµενη ως σύνολο". (Blackburn,1996). Γενικά xρόνος χαρακτηρίζεται η ακριβής µέτρηση µιας διαδικασίας από το παρελθόν στο µέλλον" (Μπούσουλας, 2016).
